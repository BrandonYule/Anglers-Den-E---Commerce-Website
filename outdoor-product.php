...
<div class="about-img" >
  <center><h1 class="over-head" ><b>Outdoor Products</b></h1></center>
</div>
<center> <h1 class="f-p">Available Outdoor Products</h1></center>

<!-- add product from database  -->

<div class="product-row">
<?php 
            $my="SELECT * FROM products  WHERE category = 'outdoor product'";
