...
<div class="bg-img" >
  <center><h1 class="over-head" ><b>Fishing products</b></h1></center>
</div>

<center> <h1 class="f-p">Available Fishing Products</h1></center>

<!-- add products from database -->

<div class="product-row">
<?php 
            $my="SELECT * FROM products  WHERE category = 'Fishing product'";
